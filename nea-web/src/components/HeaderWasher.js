...
class HeaderWasher extends React.Component  {
        ...
        return (
            <div style={{flexDirection:"row", alignSelf: 'stretch'}}>
                <div style={{width: width /3}}>
                    ...
                    >
                        <img
                            ...
                            src={require('../assets/imgs/hamburger_menu.png')}
                        />
                    </Button>
                </div>
                ...
                <Button
                        ...
                        onClick={() => this.props.navigation.navigate("NotificationsWasher")}
                        >
                            <div >
                            <img 
