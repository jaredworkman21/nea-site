...
class NotificationsWasher extends React.Component {
    state = {
        ...
        <ScrollView>
            <div style={{alignItems: 'center'}}>
                    ...
                    <div style={{alignItems: 'center', marginTop: 30, marginBottom: 30}}>
                      <div style={{alignItems: 'center'}}>
                            {this.props.washer.notifications.map(notification => (
                                <div 
                                // key={notification.id}
                                >
                                ...
                                {(notification.type == 'is-review') && 
                                    <div 
                                    >
                                        <Button 
                                        style={styles.cardblock}
                                        onClick={()=> this.selectReview(notification)}
                                        >
                                         <div style={{flexDirection: 'row', justifyContent: 'center',  margin: 20}}>
...
const styles = {
  ...
  export default connect(mapStateToProps)(NotificationsWasher);